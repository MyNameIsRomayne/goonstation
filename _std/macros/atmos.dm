...
#define _LIST_MOLES_REPORT(GAS, _, NAME, MIXTURE, LIST) LIST += NAME; LIST += MIXTURE.GAS;
#define LIST_MOLES_REPORT(MIXTURE, LIST) APPLY_TO_GASES(_LIST_MOLES_REPORT, MIXTURE, LIST)
