...
/atom/movable/screen/ability/topBar/blob
	tens_offset_x = 19
	tens_offset_y = 7
	secs_offset_x = 23
	secs_offset_y = 7
...
/atom/movable/screen/ability/bottomBar/blob
	tens_offset_x = 19
	tens_offset_y = 7
	secs_offset_x = 23
	secs_offset_y = 7
...
/datum/targetable/blobAbility/upgrade
	...
	cast(atom/target)
		if (..())
			return
		owner.viewing_upgrade = !owner.viewing_upgrades
		owner.updateButtons()
