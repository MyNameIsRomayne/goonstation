...
/datum/game_mode/construction/pre_setup()
	...
	switch (supply_loc)
		...
		if ("northeast")
			...
			manx = bx + 9
			doory = by + 1
	var/list/manufacturers = list(/obj/machinery/manufacturer/general, /obj/machinery/manufacturer/hangar,  /obj/machinery/material_processor, /obj/storage/crate/abcumarker, /obj/machinery/abcu, /obj/machinery/abcu)
